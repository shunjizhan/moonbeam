...
export default {
  ...
  /**
   * Lookup54: moonbeam_runtime::ProxyType
   **/
  ...
  /**
   * Lookup84: frame_support::traits::preimages::Bounded<moonbeam_runtime::RuntimeCall>
   **/
  ...
  /**
   * Lookup118: moonbeam_runtime::OriginCaller
   **/
  ...
  /**
   * Lookup119: frame_support::dispatch::RawOrigin<account::AccountId20>
   **/
  ...
  /**
   * Lookup121: moonbeam_runtime::governance::origins::custom_origins::Origin
   **/
  ...
  /**
   * Lookup301: moonbeam_runtime::xcm_config::AssetType
   **/
  ...
  /**
   * Lookup302: moonbeam_runtime::asset_config::AssetRegistrarMetadata
   **/
  ...
  /**
   * Lookup304: moonbeam_runtime::xcm_config::CurrencyId
   **/
  ...
  /**
   * Lookup309: moonbeam_runtime::xcm_config::Transactors
   **/
  MoonbeamRuntimeXcmConfigTransactors: {
    _enum: ['Relay']
  },
  /**
   * Lookup310: pallet_xcm_transactor::pallet::CurrencyPayment<moonbeam_runtime::xcm_config::CurrencyId>
   **/
  ...
  /**
   * Lookup311: pallet_xcm_transactor::pallet::Currency<moonbeam_runtime::xcm_config::CurrencyId>
   **/
  ...
  /**
   * Lookup391: pallet_parachain_staking::types::ParachainBondConfig<account::AccountId20>
   **/
  ...
  /**
   * Lookup394: pallet_parachain_staking::set::OrderedSet<pallet_parachain_staking::types::Bond<account::AccountId20, Balance>>
   **/
  ...
  /**
   * Lookup407: pallet_parachain_staking::auto_compound::AutoCompoundConfig<account::AccountId20>
   **/
  ...
  /**
   * Lookup420: pallet_moonbeam_orbiters::types::CollatorPoolInfo<account::AccountId20>
   **/
  ...
  /**
   * Lookup422: pallet_moonbeam_orbiters::types::CurrentOrbiter<account::AccountId20>
   **/
  ...
  /**
   * Lookup427: pallet_proxy::ProxyDefinition<account::AccountId20, moonbeam_runtime::ProxyType, BlockNumber>
   **/
  ...
  /**
   * Lookup473: pallet_scheduler::Scheduled<Name, frame_support::traits::preimages::Bounded<moonbeam_runtime::RuntimeCall>, BlockNumber, moonbeam_runtime::OriginCaller, account::AccountId20>
   **/
  ...
  /**
   * Lookup480: pallet_democracy::types::ReferendumInfo<BlockNumber, frame_support::traits::preimages::Bounded<moonbeam_runtime::RuntimeCall>, Balance>
   **/
  ...
  /**
   * Lookup481: pallet_democracy::types::ReferendumStatus<BlockNumber, frame_support::traits::preimages::Bounded<moonbeam_runtime::RuntimeCall>, Balance>
   **/
  ...
  /**
   * Lookup499: pallet_conviction_voting::vote::Voting<Balance, account::AccountId20, BlockNumber, PollIndex, MaxVotes>
   **/
  ...
  /**
   * Lookup511: pallet_referenda::types::ReferendumInfo<TrackId, moonbeam_runtime::OriginCaller, Moment, frame_support::traits::preimages::Bounded<moonbeam_runtime::RuntimeCall>, Balance, pallet_conviction_voting::types::Tally<Votes, Total>, account::AccountId20, ScheduleAddress>
   **/
  ...
  /**
   * Lookup512: pallet_referenda::types::ReferendumStatus<TrackId, moonbeam_runtime::OriginCaller, Moment, frame_support::traits::preimages::Bounded<moonbeam_runtime::RuntimeCall>, Balance, pallet_conviction_voting::types::Tally<Votes, Total>, account::AccountId20, ScheduleAddress>
   **/
  ...
  /**
   * Lookup592: pallet_assets::types::AssetMetadata<DepositBalance, bounded_collections::bounded_vec::BoundedVec<T, S>>
   **/
  ...
  /**
   * Lookup621: moonbeam_runtime::Runtime
   **/
